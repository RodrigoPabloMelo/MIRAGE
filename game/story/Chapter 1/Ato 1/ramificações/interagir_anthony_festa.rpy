label escolha_interagir_anthony:
    ...
    """
    Enquanto se mistura entre os convidados, Anna nota um homem de estatura média, com um terno impecavelmente ajustado, falando com um pequeno grupo.

    Ele mantém uma postura confiante, e a maneira como as pessoas ao redor dele o escutam com atenção deixa claro que é alguém de influência.
    """
    ...
    """
    O homem, que parece estar na casa dos 30, tem um cabelo castanho escuro perfeitamente penteado e um físico bem cuidado.

    Ele fala com firmeza, mas há algo mais... 

    Um certo nervosismo que seus olhos traem de vez em quando, como se ele estivesse constantemente calculando seus próximos passos.
    """
